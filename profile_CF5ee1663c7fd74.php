	...
	<div id="main" style="width:595px; max-height:842px; background:#FFF;">
			...
			<table style="width:100%;">
				<tr>
					<td style="width:60%;" align="center">
						...
						<h4>JUNIOR TRADERS APPLICATION</h4>
		...
		<div id="content" style="width:100%; height:66%; padding:5px;">
			<table class="" style="width:100%;">
				...
				<tr><td><span>MONTHLY ROI:</span> <?php echo $records['monthly_roi'] ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>MONTHLY -10%:</span> <?php echo $records['monthly_'] ?> </td></tr>
				<tr><td><span>PARENTS NAME:</span> <?php echo $records['parents_name'] ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>PARENTS PHONE NUMBER:</span> <?php echo $records['parents_phone_number'] ?> </td></tr>
				<tr><td><span>CHILD'S ACCOUNT NAME:</span> <?php echo $records['childs_account_name'] ?></td></tr>
				<tr><td><span>CHILD'S ACCOUNT NUMBER:</span> <?php echo $records['childs_account_number'] ?> </td></tr>
				<tr><td><span>BANK:</span> <?php echo $records['bank'] ?> </td></tr>
				<tr><td><span>APPLICANT'S SIGNATURE:</span> ____________________________ <span>DATE:</span> __________________</td></tr>
			</table>
		</div>
