	...
	<div id="main" style="width:595px; max-height:842px; background:#FFF;">
			...
			<table style="width:100%;">
				<tr>
					<td style="width:60%;" align="center">
						...
						<h4>ROLL-OVER APPLICATION FORM</h4>
		...
		<div id="content" style="width:100%; height:66%; padding:5px;">
			<table class="" style="width:100%;">
				...
				<tr><td><span>ROLL-OVER AMOUNT:</span> <?php echo $records['amount_to_topup'] ?> </td></tr>
				...
				<tr><td><span>PREVIOUS ROI DATE:</span> <?php echo $records['previous_roi_date'] ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>ROLL-OVER DATE:</span> <?php echo $records['roll_over_date'] ?> </td></tr>
